...
public class ReflectionAssist
{
    ...
    public static object Construct(Type rType, object rInstObj, params object[] rParams)
    {
        ConstructorInfo rConstructorInfo = GetConstructorInfo(flags_all, rType);
        return rConstructorInfo.Invoke(rInstObj, rParams);
    }
